...
<%
	...
	for (int i = 19; i >= 1; i--) {
		match_week = i;
		matches = matchesController.searchMatchesByTeamIdAndMatchWeek(10, match_week);
				...
				<div class="carousel-inner" role="listbox">
					<div class="carousel-item active">
						<a href="#"> <img class="img-responsive"
							src="/ProjectWeb/images/ManCity_1.jpg" alt="">
						</a>
					...
					<div class="carousel-item">
						<a href="#"> <img class="img-responsive"
							src="/ProjectWeb/images/ManCity2.jpg" alt="">
						</a>
						<div class="carousel-caption">
					...
					<div class="carousel-item">
						<a href="#"> <img class="img-responsive"
							src="/ProjectWeb/images/ManCity3.jpg" alt="">
						</a>
						<div class="carousel-caption">
