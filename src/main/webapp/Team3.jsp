...
<%
	...
	for (int i = 19; i >= 1; i--) {
		...
		String homeTeam = matchesController.searchTeam(
				matches.getHometeam()).getTeamname();
		String awayTeam = matchesController.searchTeam(
				matches.getAwayteam()).getTeamname();
				...
				<div class="carousel-inner" role="listbox">
					<div class="carousel-item active">
						<a href="#"> <img class="img-responsive"
							src="/ProjectWeb/images/Arsenal_4.jpg" alt="">
						</a>
						
					</div>
					<div class="carousel-item">
						<a href="#"> <img class="img-responsive"
							src="/ProjectWeb/images/Arsenal_2.jpg"  alt="">
						</a>
					</div>
					<div class="carousel-item">
						<a href="#"> <img class="img-responsive"
							src="/ProjectWeb/images/Arsenal_3.jpg"  alt="">
						</a>
